...
running command...
$ testcli (--version)
testcli/0.0.0 win32-x64 node-v14.19.0
...
* [`testcli help [COMMAND]`](#testcli-help-command)
...
_See code: [dist/commands/hello/index.ts](https://github.com/CLI_PRACTICE/hello-world/blob/v0.0.0/dist/commands/hello/index.ts)_
